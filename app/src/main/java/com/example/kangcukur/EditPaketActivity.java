...
public class EditPaketActivity extends AppCompatActivity {
    private TextInputEditText etPaket, etLay1, etLay2, etLay3, etLay4, etharga;
    private MaterialButton editPaket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editPaket = findViewById(R.id.btnAdd);
        editPaket.setOnClickListener(v-> {
            ...
            Intent edit = new Intent(EditPaketActivity.this, ListDaftarActivity.class);
            startActivity(edit);
        });
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(getApplicationContext(), "Berhasil mengubah!", Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
